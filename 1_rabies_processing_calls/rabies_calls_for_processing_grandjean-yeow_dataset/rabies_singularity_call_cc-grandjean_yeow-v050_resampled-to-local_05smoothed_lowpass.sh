...
-B /scratch/m/mchakrav/uromil/rabies_runs/mediso-grandjean_yeow-forCAP/rabies_out_cc-v050_resampled-to-local_05smoothed_lowpass:/confound_corr_data \
...
#matching to my local confound correction